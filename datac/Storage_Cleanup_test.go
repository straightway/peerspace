...
type Storage_Cleanup_Test struct {
	Storage_TestBase
}

func TestDataStorage_Cleanup(t *testing.T) {
	suite.Run(t, new(Storage_Cleanup_Test))
}

// Tests

func (suite *Storage_Cleanup_Test) Test_DeleteNoChunksIfEnoughSpaceIsFree() {
...
func (suite *Storage_Cleanup_Test) Test_RefuseStorageIfChunkIsTooBig() {
...
func (suite *Storage_Cleanup_Test) Test_DeleteLeastImportantChunkIfNoSpaceLeft() {
...
func (suite *Storage_Cleanup_Test) Test_DeleteSeveralChunksIfNeeded() {
...
func (suite *Storage_Cleanup_Test) Test_DeleteNoChunksIfNoChunkIsBiggerThanOverallStorageSize() {
...
func (suite *Storage_Cleanup_Test) Test_RePrioritizeExpiredChunksBeforeCleanup() {
	suite.createTestChunksOfSize(10, 2)
	...
	suite.sut.PriorityGenerator = data.NewPriorityGeneratorMock(newPrio, times.Max())
...
func (suite *Storage_Cleanup_Test) createTestChunksOfSize(size, number int) (result []*data.Chunk) {
