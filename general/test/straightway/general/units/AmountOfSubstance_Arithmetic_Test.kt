...
class AmountOfSubstance_Arithmetic_Test {

    private fun <Q: EN> product1(f: Q) =
        ProductOfBaseQuantities(f, NoI, NoL, NoJ, NoM, NoTheta, NoT)
    private fun <Q: EN> product2(f: Q) =
        ProductOfBaseQuantities(f, linear(ampere), NoL, NoJ, NoM, NoTheta, NoT)
    private val factor = mol
