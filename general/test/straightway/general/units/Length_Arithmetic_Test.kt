...
class Length_Arithmetic_Test {

    private fun <Q: EL> product1(f: Q) =
        ProductOfBaseQuantities(NoN, NoI, f, NoJ, NoM, NoTheta, NoT)
    private fun <Q: EL> product2(f: Q) =
        ProductOfBaseQuantities(linear(mol), NoI, f, NoJ, NoM, NoTheta, NoT)
    private val factor = meter
