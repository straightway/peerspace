...
class LuminousIntensity_Arithmetic_Test {

    private fun <Q: EJ> product1(f: Q) =
        ProductOfBaseQuantities(NoN, NoI, NoL, f, NoM, NoTheta, NoT)
    private fun <Q: EJ> product2(f: Q) =
        ProductOfBaseQuantities(linear(mol), NoI, NoL, f, NoM, NoTheta, NoT)
    private val factor = candela
