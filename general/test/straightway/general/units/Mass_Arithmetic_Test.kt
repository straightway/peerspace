...
class Mass_Arithmetic_Test {

    private fun <Q: EM> product1(f: Q) =
        ProductOfBaseQuantities(NoN, NoI, NoL, NoJ, f, NoTheta, NoT)
    private fun <Q: EM> product2(f: Q) =
        ProductOfBaseQuantities(linear(mol), NoI, NoL, NoJ, f, NoTheta, NoT)
    private val factor = kilo(gramm)
