...
class Temperature_Arithmetic_Test {

    private fun <Q: ETheta> product1(f: Q) =
        ProductOfBaseQuantities(NoN, NoI, NoL, NoJ, NoM, f, NoT)
    private fun <Q: ETheta> product2(f: Q) =
        ProductOfBaseQuantities(linear(mol), NoI, NoL, NoJ, NoM, f, NoT)
    private val factor = kelvin
