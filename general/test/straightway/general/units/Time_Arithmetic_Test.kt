...
class Time_Arithmetic_Test {

    private fun <Q: ET> product1(f: Q) =
        ProductOfBaseQuantities(NoN, NoI, NoL, NoJ, NoM, NoTheta, f)
    private fun <Q: ET> product2(f: Q) =
        ProductOfBaseQuantities(linear(mol), NoI, NoL, NoJ, NoM, NoTheta, f)
    private val factor = second
