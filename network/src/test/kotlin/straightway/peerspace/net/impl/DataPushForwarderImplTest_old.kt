...
class DataPushForwarderImplTest_old : KoinTestBase() {
    ...
    private val test get() = Given {
        ...
        object {
            ...
            private val forwardTracker get() = environment
                    .get<ForwardStateTracker<PushRequest, Key>>("pushForwardTracker")
    ...
    fun `forwarding to one peer leads to a pending state for this peer`() =
            test while_ {
                ...
                expect(forwardStates is_ Equal to_ Values(
                        Pair(
