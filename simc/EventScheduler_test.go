...
type EventScheduler_Test struct {
	suite.Suite
	sut *EventScheduler
}
...
func TestEventScheduler(t *testing.T) {
	suite.Run(t, new(EventScheduler_Test))
}
...
func (suite *EventScheduler_Test) Test_Run_OnInitialStateDoesNothing() {
	suite.sut.Run()
}

func (suite *EventScheduler_Test) Test_Run_ExecutesPreScheduledEvent() {
	wasCalled := false
...
func (suite *EventScheduler_Test) Test_Run_ActionAtScheduledTime() {
...
func (suite *EventScheduler_Test) Test_Run_AdvancesTimeWithEvent() {
	eventDuration := duration.Parse("10s")
	suite.sut.Schedule(eventDuration, func() {})
...
func (suite *EventScheduler_Test) Test_Run_ExecutesEventsInTimedOrder() {
	eventIndex := 0
...
func (suite *EventScheduler_Test) Test_Schedule_ChainedEvents() {
	eventDuration := duration.Parse("10s")
	wasCalled := false
	suite.sut.Schedule(eventDuration, func() {
...
func (suite *EventScheduler_Test) Test_Schedule_PanicsWithNegativeTimes() {
...
func (suite *EventScheduler_Test) Test_ScheduleAbsolute() {
	wasCalled := false
...
func (suite *EventScheduler_Test) Test_ScheduleAbsolutePanicsWhenSchedulingPastEvent() {
	targetDateTime, err := time.Parse(timeFormat, "2000-01-01 08:45:13")
	suite.Assert().Nil(err)
	suite.sut.ScheduleAbsolute(targetDateTime, func() {})
	suite.sut.Run()
...
func (suite *EventScheduler_Test) Test_Stop_StopsAfterCurrentEvent() {
...
func (suite *EventScheduler_Test) Test_Stop_IgnoresFollowingEvents() {
	suite.sut.Schedule(duration.Parse("10s"), func() {
		suite.sut.Stop()
		suite.sut.Schedule(duration.Parse("20s"), func() {
			suite.Assert().Fail("Should not be executed as the scheduler is stopped before")
...
func (suite *EventScheduler_Test) Test_Reset_ClearsRemainingEvents() {
	suite.sut.Schedule(duration.Parse("20s"), func() {
		suite.Assert().Fail("Should not be executed as the scheduler is stopped before")
	})
	suite.sut.Reset()
...
func (suite *EventScheduler_Test) Test_Reset_ResumesForNewEvents() {
...
func (suite *EventScheduler_Test) Test_Reset_ResetsSimulationTime() {
	suite.sut.Schedule(duration.Parse("20s"), func() {})
	suite.sut.Run()
	suite.sut.Reset()
	suite.Assert().Equal(time.Time{}.In(time.UTC), suite.sut.Time())
...
func (suite *EventScheduler_Test) Test_ExecNext_ReturnsFalseWithoutEvents() {
	suite.Assert().False(suite.sut.ExecNext())
}

func (suite *EventScheduler_Test) Test_ExecNext_TriggersNoExecEventWithoutSimulationEvents() {
	suite.sut.RegisterForExecEvent(func() { suite.Fail("Unexpected event") })
	suite.Assert().NotPanics(func() { suite.sut.ExecNext() })
}

func (suite *EventScheduler_Test) Test_ExecNext_ReturnsTrueWithEvents() {
	suite.sut.Schedule(time.Duration(0), func() {})
	suite.Assert().True(suite.sut.ExecNext())
}

func (suite *EventScheduler_Test) Test_ExecNext_TriggersExecEventWithSimulationEvents() {
...
func (suite *EventScheduler_Test) Test_ExecNext_ExecutesNextEvent() {
	isExecuted := false
...
func (suite *EventScheduler_Test) Test_ExecNext_ExecutesOneEvent() {
	suite.sut.Schedule(time.Duration(0), func() {})
...
func (suite *EventScheduler_Test) Test_ExecNext_SetsTime() {
...
func (suite *EventScheduler_Test) Test_ExecNext_ExecutesNotIfStopped() {
	suite.sut.Schedule(time.Duration(0), func() {
...
func (suite *EventScheduler_Test) Test_ExecNext_ExecutesNextEventIsStoppedAndResumed() {
	isExecuted := false
	suite.sut.Schedule(time.Duration(0), func() { isExecuted = true })
	suite.sut.Stop()
	suite.sut.Resume()
