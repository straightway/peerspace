...
func TestActionHandler(t *testing.T) {
	suite.Run(t, new(ActionHandler_Test))
}
...
func (suite *ActionHandler_Test) TearDownTest() {
	log.SetHandler(nil)
...
func (suite *ActionHandler_Test) Test_EntryTypeOtherThanNodeActionIsForwarded() {
...
func (suite *ActionHandler_Test) Test_EntryTypeNodeActionIsFormatted() {
	fields := log.Fields{
...
func (suite *ActionHandler_Test) Test_EntryTypeNodeActionIsFormatted2() {
	fields := log.Fields{
		"EntryType":   "NodeAction",
		"Origin":      2,
		"Destination": 3,
...
func (suite *ActionHandler_Test) Test_EntryTypeNodeActionIsFormattedWithoutParameterIfMissing() {
	fields := log.Fields{
		"EntryType":   "NodeAction",
		"Origin":      1,
		"Destination": 2,
...
func (suite *ActionHandler_Test) Test_EntryTypeNodeActionIsFormattedWithoutOrigin() {
	fields := log.Fields{
		"EntryType":   "NodeAction",
		"Destination": 2,
		"Function":    "Func",
...
func (suite *ActionHandler_Test) Test_EntryTypeNodeActionIsFormattedWithoutDestination() {
	fields := log.Fields{
		"EntryType": "NodeAction",
		"Origin":    1,
		"Function":  "Func",
...
func (suite *ActionHandler_Test) Test_EntryTypeNodeActionIsFormattedWithoutFunction() {
	fields := log.Fields{
		"EntryType":   "NodeAction",
		"Origin":      1,
		"Destination": 2,
...
func (suite *ActionHandler_Test) Test_EntryTypeNodeActionIsFormattedWithoutMessage() {
	fields := log.Fields{
		"EntryType":   "NodeAction",
		"Origin":      1,
		"Destination": 2,
...
func (suite *ActionHandler_Test) Test_EntryTypeNodeListAdditionalFields() {
	fields := log.Fields{
		"EntryType":   "NodeAction",
		"Origin":      1,
		"Destination": 2,
...
func (suite *ActionHandler_Test) Test_EntryTypeNodeSubFields() {
...
func (suite *ActionHandler_Test) Test_EntryTypeNodeEmptySubFields() {
	subFields := []log.Fields{}
	fields := log.Fields{
		"EntryType":   "NodeAction",
		"Origin":      1,
...
func (suite *ActionHandler_Test) Test_EntryTypeDeferredSubFields_NotLoggedImmediately() {
...
func (suite *ActionHandler_Test) Test_EntryTypeDeferredSubFields_LoggedWhenOriginChanges() {
	subFields := []log.Fields{log.Fields{"Deferred": true}}
	fields := log.Fields{
		"EntryType": "NodeAction",
		"Origin":    1,
...
func (suite *ActionHandler_Test) Test_EntryTypeDeferredSubFields_LoggedWhenTimeChanges() {
	subFields := []log.Fields{log.Fields{"Deferred": true}}
	fields := log.Fields{
		"EntryType": "NodeAction",
		"Origin":    1,
...
func (suite *ActionHandler_Test) Test_EntryTypeDeferredSubFields_LoggedWithOldTimeWhenTimeChanges() {
	subFields := []log.Fields{log.Fields{"Deferred": true}}
	fields := log.Fields{
		"EntryType": "NodeAction",
		"Origin":    1,
...
func (suite *ActionHandler_Test) Test_EntryTypeNodeActionIsFormattedWithDuration() {
	fields := log.Fields{
		"EntryType":   "NodeAction",
...
func (suite *ActionHandler_Test) setupBaseHandlerForLog(
	message string,
	fields log.Fields) {
...
func (suite *ActionHandler_Test) setupBaseHandlerForLogs(logEntries ...logEntry) {
	nextAssertIndex := 0
	suite.baseHandler.OnNew("HandleLog", mock.Anything).Run(func(args mock.Arguments) {
